...
000003fb <get_siblings_info>:
SYSCALL(get_siblings_info)
 3fb:	b8 19 00 00 00       	mov    $0x19,%eax
 400:	cd 40                	int    $0x40
 402:	c3                   	ret    

00000403 <signalProcess>:
 ...
 49c:	89 d1                	mov    %edx,%ecx
{
 ...
 50e:	56                   	push   %esi
 50f:	57                   	push   %edi
 510:	e8 4e fe ff ff       	call   363 <write>
  while(--i >= 0)
 ...
 549:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 585:	57                   	push   %edi
 586:	56                   	push   %esi
 587:	e8 d7 fd ff ff       	call   363 <write>
 ...
 5de:	e8 80 fd ff ff       	call   363 <write>
        putc(fd, c);
 ...
 5ef:	57                   	push   %edi
 5f0:	56                   	push   %esi
 5f1:	e8 6d fd ff ff       	call   363 <write>
        putc(fd, c);
 ...
 69c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 69f:	e8 bf fc ff ff       	call   363 <write>
        ap++;
...
free(void *ap)
{
 ...
 6e1:	a1 cc 0b 00 00       	mov    0xbcc,%eax
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	89 15 cc 0b 00 00    	mov    %edx,0xbcc
}
 728:	5e                   	pop    %esi
 729:	5f                   	pop    %edi
 72a:	5d                   	pop    %ebp
 ...
 759:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 75c:	89 15 cc 0b 00 00    	mov    %edx,0xbcc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 3d cc 0b 00 00    	mov    0xbcc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bf:	73 4f                	jae    810 <malloc+0xa0>
    ...
    if(p == freep)
 7c1:	8b 3d cc 0b 00 00    	mov    0xbcc,%edi
 ...
 7d3:	e8 f3 fb ff ff       	call   3cb <sbrk>
  if(p == (char*)-1)
 ...
 7ea:	e8 f1 fe ff ff       	call   6e0 <free>
  return freep;
 7ef:	8b 15 cc 0b 00 00    	mov    0xbcc,%edx
 ...
 81c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 81f:	89 15 cc 0b 00 00    	mov    %edx,0xbcc
}
 ...
 82f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 830:	c7 05 cc 0b 00 00 d0 	movl   $0xbd0,0xbcc
 837:	0b 00 00 
    base.s.size = 0;
 83a:	bf d0 0b 00 00       	mov    $0xbd0,%edi
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 d0 0b 00 00 d0 	movl   $0xbd0,0xbd0
 846:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 849:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 84b:	c7 05 d4 0b 00 00 00 	movl   $0x0,0xbd4
 852:	00 00 00 
    if(p->s.size >= nunits){
