  ...
  44:	31 db                	xor    %ebx,%ebx
{
  ...
  write(fd, s, strlen(s));
  49:	68 b4 04 00 00       	push   $0x4b4
  4e:	e8 5d 01 00 00       	call   1b0 <strlen>
  53:	83 c4 0c             	add    $0xc,%esp
  56:	50                   	push   %eax
  57:	68 b4 04 00 00       	push   $0x4b4
  5c:	6a 01                	push   $0x1
  ...
  ab:	68 e6 04 00 00       	push   $0x4e6
  b0:	e8 fb 00 00 00       	call   1b0 <strlen>
  b5:	83 c4 0c             	add    $0xc,%esp
  b8:	50                   	push   %eax
  b9:	68 e6 04 00 00       	push   $0x4e6
  be:	6a 01                	push   $0x1
  ...
  d2:	68 bf 04 00 00       	push   $0x4bf
  d7:	e8 d4 00 00 00       	call   1b0 <strlen>
  dc:	83 c4 0c             	add    $0xc,%esp
  df:	50                   	push   %eax
  e0:	68 bf 04 00 00       	push   $0x4bf
  e5:	6a 01                	push   $0x1
...
0000042b <get_siblings_info>:
SYSCALL(get_siblings_info)
 42b:	b8 19 00 00 00       	mov    $0x19,%eax
 430:	cd 40                	int    $0x40
 432:	c3                   	ret    

00000433 <signalProcess>:
