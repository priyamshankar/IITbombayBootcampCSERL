...
0000041b <get_siblings_info>:
SYSCALL(get_siblings_info)
 41b:	b8 19 00 00 00       	mov    $0x19,%eax
 420:	cd 40                	int    $0x40
 422:	c3                   	ret    

00000423 <signalProcess>:
 ...
 4bc:	89 d1                	mov    %edx,%ecx
{
 ...
 52e:	56                   	push   %esi
 52f:	57                   	push   %edi
 530:	e8 4e fe ff ff       	call   383 <write>
  while(--i >= 0)
 ...
 569:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5a5:	57                   	push   %edi
 5a6:	56                   	push   %esi
 5a7:	e8 d7 fd ff ff       	call   383 <write>
 ...
 5fe:	e8 80 fd ff ff       	call   383 <write>
        putc(fd, c);
 ...
 60f:	57                   	push   %edi
 610:	56                   	push   %esi
 611:	e8 6d fd ff ff       	call   383 <write>
        putc(fd, c);
 ...
 6bc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6bf:	e8 bf fc ff ff       	call   383 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 7f3:	e8 f3 fb ff ff       	call   3eb <sbrk>
  if(p == (char*)-1)
