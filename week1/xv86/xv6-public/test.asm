  ...
  10:	bb 10 27 00 00       	mov    $0x2710,%ebx
{
  ...
  16:	83 ec 08             	sub    $0x8,%esp
    init_counter();
  19:	e8 8d 03 00 00       	call   3ab <init_counter>
    int ret = fork();
  1e:	e8 a8 02 00 00       	call   2cb <fork>
  23:	89 c7                	mov    %eax,%edi
    int id = init_mylock();
  25:	e8 c9 03 00 00       	call   3f3 <init_mylock>
    acquire_mylock(id);
  ...
  2e:	89 c6                	mov    %eax,%esi
    acquire_mylock(id);
  30:	e8 c6 03 00 00       	call   3fb <acquire_mylock>
  ...
  3f:	90                   	nop
    ...
    {
        update_cnt();
  40:	e8 6e 03 00 00       	call   3b3 <update_cnt>
    for (int i = 0; i < 10000; i++)
  ...
  4d:	56                   	push   %esi
  4e:	e8 b0 03 00 00       	call   403 <release_mylock>

    if (ret == 0)
  53:	83 c4 10             	add    $0x10,%esp
  56:	85 ff                	test   %edi,%edi
  ...
  5a:	e8 74 02 00 00       	call   2d3 <exit>
    ...
    else
    {
        // acquire_mylock(id);
        wait();
  5f:	e8 77 02 00 00       	call   2db <wait>
        printf(1, "%d\n", display_count());
  64:	e8 52 03 00 00       	call   3bb <display_count>
  69:	52                   	push   %edx
  6a:	50                   	push   %eax
...
0000038b <get_siblings_info>:
SYSCALL(get_siblings_info)
 38b:	b8 19 00 00 00       	mov    $0x19,%eax
 390:	cd 40                	int    $0x40
 392:	c3                   	ret    

00000393 <signalProcess>:
 ...
 42c:	89 d1                	mov    %edx,%ecx
{
 ...
 459:	0f b6 92 5c 08 00 00 	movzbl 0x85c(%edx),%edx
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 515:	57                   	push   %edi
 516:	56                   	push   %esi
 517:	e8 d7 fd ff ff       	call   2f3 <write>
 ...
 549:	ff 24 85 04 08 00 00 	jmp    *0x804(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 56e:	e8 80 fd ff ff       	call   2f3 <write>
        putc(fd, c);
 ...
 57f:	57                   	push   %edi
 580:	56                   	push   %esi
 581:	e8 6d fd ff ff       	call   2f3 <write>
        putc(fd, c);
 ...
 62c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 62f:	e8 bf fc ff ff       	call   2f3 <write>
        ap++;
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba fc 07 00 00       	mov    $0x7fc,%edx
        while(*s != 0){
 ...
 671:	a1 14 0b 00 00       	mov    0xb14,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 14 0b 00 00    	mov    %edx,0xb14
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 14 0b 00 00    	mov    %edx,0xb14
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d 14 0b 00 00    	mov    0xb14,%edi
 ...
 763:	e8 f3 fb ff ff       	call   35b <sbrk>
  if(p == (char*)-1)
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 14 0b 00 00    	mov    0xb14,%edx
 ...
 7ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7af:	89 15 14 0b 00 00    	mov    %edx,0xb14
}
 ...
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf 18 0b 00 00       	mov    $0xb18,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 18 0b 00 00 18 	movl   $0xb18,0xb18
 7d6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 1c 0b 00 00 00 	movl   $0x0,0xb1c
 7e2:	00 00 00 
    if(p->s.size >= nunits){
