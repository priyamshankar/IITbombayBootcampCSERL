...
0000037b <get_siblings_info>:
SYSCALL(get_siblings_info)
 37b:	b8 19 00 00 00       	mov    $0x19,%eax
 380:	cd 40                	int    $0x40
 382:	c3                   	ret    

00000383 <signalProcess>:
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 48e:	56                   	push   %esi
 48f:	57                   	push   %edi
 490:	e8 4e fe ff ff       	call   2e3 <write>
  while(--i >= 0)
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 505:	57                   	push   %edi
 506:	56                   	push   %esi
 507:	e8 d7 fd ff ff       	call   2e3 <write>
 ...
 55e:	e8 80 fd ff ff       	call   2e3 <write>
        putc(fd, c);
 ...
 56f:	57                   	push   %edi
 570:	56                   	push   %esi
 571:	e8 6d fd ff ff       	call   2e3 <write>
        putc(fd, c);
 ...
 61c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 61f:	e8 bf fc ff ff       	call   2e3 <write>
        ap++;
 ...
 661:	a1 04 0b 00 00       	mov    0xb04,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 04 0b 00 00    	mov    %edx,0xb04
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 04 0b 00 00    	mov    %edx,0xb04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d 04 0b 00 00    	mov    0xb04,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d 04 0b 00 00    	mov    0xb04,%edi
 ...
 753:	e8 f3 fb ff ff       	call   34b <sbrk>
  if(p == (char*)-1)
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 04 0b 00 00    	mov    0xb04,%edx
 ...
 79c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 79f:	89 15 04 0b 00 00    	mov    %edx,0xb04
}
