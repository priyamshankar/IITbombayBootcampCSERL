...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       ...
       b:	ff 35 34 5c 00 00    	push   0x5c34
      11:	e8 e7 38 00 00       	call   38fd <printf>
  ...
  printf(stdout, "iput test ok\n");
      ...
      6d:	ff 35 34 5c 00 00    	push   0x5c34
      73:	e8 85 38 00 00       	call   38fd <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
      ...
      85:	ff 35 34 5c 00 00    	push   0x5c34
      8b:	e8 6d 38 00 00       	call   38fd <printf>
    exit();
      90:	e8 83 36 00 00       	call   3718 <exit>
    printf(stdout, "chdir iputdir failed\n");
      95:	83 ec 08             	sub    $0x8,%esp
      98:	68 ba 3b 00 00       	push   $0x3bba
      9d:	ff 35 34 5c 00 00    	push   0x5c34
      a3:	e8 55 38 00 00       	call   38fd <printf>
    exit();
      a8:	e8 6b 36 00 00       	call   3718 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
      ad:	83 ec 08             	sub    $0x8,%esp
      b0:	68 db 3b 00 00       	push   $0x3bdb
      b5:	ff 35 34 5c 00 00    	push   0x5c34
      bb:	e8 3d 38 00 00       	call   38fd <printf>
    exit();
      c0:	e8 53 36 00 00       	call   3718 <exit>
    printf(stdout, "chdir / failed\n");
      c5:	83 ec 08             	sub    $0x8,%esp
      c8:	68 f7 3b 00 00       	push   $0x3bf7
      cd:	ff 35 34 5c 00 00    	push   0x5c34
      d3:	e8 25 38 00 00       	call   38fd <printf>
    exit();
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      ...
      e8:	ff 35 34 5c 00 00    	push   0x5c34
      ee:	e8 0a 38 00 00       	call   38fd <printf>
  ...
  if(pid == 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     14e:	ff 35 34 5c 00 00    	push   0x5c34
     154:	e8 a4 37 00 00       	call   38fd <printf>
    exit();
     159:	e8 ba 35 00 00       	call   3718 <exit>
      printf(stdout, "mkdir failed\n");
     15e:	83 ec 08             	sub    $0x8,%esp
     161:	68 ac 3b 00 00       	push   $0x3bac
     166:	ff 35 34 5c 00 00    	push   0x5c34
     16c:	e8 8c 37 00 00       	call   38fd <printf>
      exit();
     171:	e8 a2 35 00 00       	call   3718 <exit>
      printf(stdout, "child chdir failed\n");
     176:	83 ec 08             	sub    $0x8,%esp
     179:	68 16 3c 00 00       	push   $0x3c16
     17e:	ff 35 34 5c 00 00    	push   0x5c34
     184:	e8 74 37 00 00       	call   38fd <printf>
      exit();
     189:	e8 8a 35 00 00       	call   3718 <exit>
      printf(stdout, "unlink ../iputdir failed\n");
     18e:	83 ec 08             	sub    $0x8,%esp
     191:	68 db 3b 00 00       	push   $0x3bdb
     196:	ff 35 34 5c 00 00    	push   0x5c34
     19c:	e8 5c 37 00 00       	call   38fd <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     1b3:	ff 35 34 5c 00 00    	push   0x5c34
     1b9:	e8 3f 37 00 00       	call   38fd <printf>
}
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     ...
     1ce:	ff 35 34 5c 00 00    	push   0x5c34
     1d4:	e8 24 37 00 00       	call   38fd <printf>
  if(mkdir("oidir") < 0){
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     215:	ff 35 34 5c 00 00    	push   0x5c34
     21b:	e8 dd 36 00 00       	call   38fd <printf>
      exit();
     220:	e8 f3 34 00 00       	call   3718 <exit>
    printf(stdout, "mkdir oidir failed\n");
     225:	83 ec 08             	sub    $0x8,%esp
     228:	68 51 3c 00 00       	push   $0x3c51
     22d:	ff 35 34 5c 00 00    	push   0x5c34
     233:	e8 c5 36 00 00       	call   38fd <printf>
    exit();
     238:	e8 db 34 00 00       	call   3718 <exit>
    printf(stdout, "fork failed\n");
     23d:	83 ec 08             	sub    $0x8,%esp
     240:	68 ed 4a 00 00       	push   $0x4aed
     245:	ff 35 34 5c 00 00    	push   0x5c34
     24b:	e8 ad 36 00 00       	call   38fd <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     ...
     284:	ff 35 34 5c 00 00    	push   0x5c34
     28a:	e8 6e 36 00 00       	call   38fd <printf>
}
    ...
    printf(stdout, "unlink failed\n");
     ...
     29c:	ff 35 34 5c 00 00    	push   0x5c34
     2a2:	e8 56 36 00 00       	call   38fd <printf>
    exit();
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     ...
     2b7:	ff 35 34 5c 00 00    	push   0x5c34
     2bd:	e8 3b 36 00 00       	call   38fd <printf>
  fd = open("echo", 0);
  ...
  printf(stdout, "open test ok\n");
     ...
     2ff:	ff 35 34 5c 00 00    	push   0x5c34
     305:	e8 f3 35 00 00       	call   38fd <printf>
}
    ...
    printf(stdout, "open echo failed!\n");
     ...
     317:	ff 35 34 5c 00 00    	push   0x5c34
     31d:	e8 db 35 00 00       	call   38fd <printf>
    exit();
     322:	e8 f1 33 00 00       	call   3718 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     327:	83 ec 08             	sub    $0x8,%esp
     32a:	68 b6 3c 00 00       	push   $0x3cb6
     32f:	ff 35 34 5c 00 00    	push   0x5c34
     335:	e8 c3 35 00 00       	call   38fd <printf>
    exit();
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     34c:	ff 35 34 5c 00 00    	push   0x5c34
     352:	e8 a6 35 00 00       	call   38fd <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     37a:	ff 35 34 5c 00 00    	push   0x5c34
     380:	e8 78 35 00 00       	call   38fd <printf>
  } else {
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     3cf:	ff 35 34 5c 00 00    	push   0x5c34
     3d5:	e8 23 35 00 00       	call   38fd <printf>
    exit();
     ...
     3e8:	ff 35 34 5c 00 00    	push   0x5c34
     3ee:	e8 0a 35 00 00       	call   38fd <printf>
      exit();
     ...
     401:	ff 35 34 5c 00 00    	push   0x5c34
     407:	e8 f1 34 00 00       	call   38fd <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     ...
     419:	ff 35 34 5c 00 00    	push   0x5c34
     41f:	e8 d9 34 00 00       	call   38fd <printf>
  close(fd);
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     44c:	ff 35 34 5c 00 00    	push   0x5c34
     452:	e8 a6 34 00 00       	call   38fd <printf>
  } else {
  ...
  i = read(fd, buf, 2000);
     ...
     45f:	68 80 83 00 00       	push   $0x8380
     464:	53                   	push   %ebx
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     47c:	ff 35 34 5c 00 00    	push   0x5c34
     482:	e8 76 34 00 00       	call   38fd <printf>
  } else {
  ...
  printf(stdout, "small file test ok\n");
     ...
     4aa:	ff 35 34 5c 00 00    	push   0x5c34
     4b0:	e8 48 34 00 00       	call   38fd <printf>
}
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     4c7:	ff 35 34 5c 00 00    	push   0x5c34
     4cd:	e8 2b 34 00 00       	call   38fd <printf>
    exit();
     4d2:	e8 41 32 00 00       	call   3718 <exit>
    printf(stdout, "read failed\n");
     4d7:	83 ec 08             	sub    $0x8,%esp
     4da:	68 b1 40 00 00       	push   $0x40b1
     4df:	ff 35 34 5c 00 00    	push   0x5c34
     4e5:	e8 13 34 00 00       	call   38fd <printf>
    exit();
     4ea:	e8 29 32 00 00       	call   3718 <exit>
    printf(stdout, "unlink small failed\n");
     4ef:	83 ec 08             	sub    $0x8,%esp
     4f2:	68 98 3d 00 00       	push   $0x3d98
     4f7:	ff 35 34 5c 00 00    	push   0x5c34
     4fd:	e8 fb 33 00 00       	call   38fd <printf>
    exit();
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     514:	ff 35 34 5c 00 00    	push   0x5c34
     51a:	e8 de 33 00 00       	call   38fd <printf>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     547:	89 1d 80 83 00 00    	mov    %ebx,0x8380
    if(write(fd, buf, 512) != 512){
     54d:	83 ec 04             	sub    $0x4,%esp
     550:	68 00 02 00 00       	push   $0x200
     555:	68 80 83 00 00       	push   $0x8380
     55a:	56                   	push   %esi
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     577:	ff 35 34 5c 00 00    	push   0x5c34
     57d:	e8 7b 33 00 00       	call   38fd <printf>
    exit();
     ...
     590:	ff 35 34 5c 00 00    	push   0x5c34
     596:	e8 62 33 00 00       	call   38fd <printf>
      exit();
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     5ce:	68 80 83 00 00       	push   $0x8380
     5d3:	56                   	push   %esi
    ...
    if(((int*)buf)[0] != n){
     5eb:	a1 80 83 00 00       	mov    0x8380,%eax
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     605:	ff 35 34 5c 00 00    	push   0x5c34
     60b:	e8 ed 32 00 00       	call   38fd <printf>
    exit();
  ...
  printf(stdout, "big files ok\n");
     ...
     641:	ff 35 34 5c 00 00    	push   0x5c34
     647:	e8 b1 32 00 00       	call   38fd <printf>
}
     ...
     65f:	ff 35 34 5c 00 00    	push   0x5c34
     665:	e8 93 32 00 00       	call   38fd <printf>
        exit();
     ...
     678:	ff 35 34 5c 00 00    	push   0x5c34
     67e:	e8 7a 32 00 00       	call   38fd <printf>
      exit();
     ...
     68f:	ff 35 34 5c 00 00    	push   0x5c34
     695:	e8 63 32 00 00       	call   38fd <printf>
      exit();
     69a:	e8 79 30 00 00       	call   3718 <exit>
    printf(stdout, "unlink big failed\n");
     69f:	83 ec 08             	sub    $0x8,%esp
     6a2:	68 4f 3e 00 00       	push   $0x3e4f
     6a7:	ff 35 34 5c 00 00    	push   0x5c34
     6ad:	e8 4b 32 00 00       	call   38fd <printf>
    exit();
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     6c3:	ff 35 34 5c 00 00    	push   0x5c34
     6c9:	e8 2f 32 00 00       	call   38fd <printf>

  name[0] = 'a';
     6ce:	c6 05 70 83 00 00 61 	movb   $0x61,0x8370
  name[2] = '\0';
     6d5:	c6 05 72 83 00 00 00 	movb   $0x0,0x8372
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     6e9:	a2 71 83 00 00       	mov    %al,0x8371
    fd = open(name, O_CREATE|O_RDWR);
     6ee:	83 ec 08             	sub    $0x8,%esp
     6f1:	68 02 02 00 00       	push   $0x202
     6f6:	68 70 83 00 00       	push   $0x8370
  ...
  name[0] = 'a';
     713:	c6 05 70 83 00 00 61 	movb   $0x61,0x8370
  name[2] = '\0';
     71a:	c6 05 72 83 00 00 00 	movb   $0x0,0x8372
  for(i = 0; i < 52; i++){
     721:	bb 00 00 00 00       	mov    $0x0,%ebx
     726:	eb 1b                	jmp    743 <createtest+0x8c>
    name[1] = '0' + i;
     728:	8d 43 30             	lea    0x30(%ebx),%eax
     72b:	a2 71 83 00 00       	mov    %al,0x8371
    unlink(name);
     730:	83 ec 0c             	sub    $0xc,%esp
     733:	68 70 83 00 00       	push   $0x8370
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     750:	ff 35 34 5c 00 00    	push   0x5c34
     756:	e8 a2 31 00 00       	call   38fd <printf>
}
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     76e:	ff 35 34 5c 00 00    	push   0x5c34
     774:	e8 84 31 00 00       	call   38fd <printf>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     7d0:	ff 35 34 5c 00 00    	push   0x5c34
     7d6:	e8 22 31 00 00       	call   38fd <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     ...
     7e8:	ff 35 34 5c 00 00    	push   0x5c34
     7ee:	e8 0a 31 00 00       	call   38fd <printf>
    exit();
     7f3:	e8 20 2f 00 00       	call   3718 <exit>
    printf(stdout, "chdir dir0 failed\n");
     7f8:	83 ec 08             	sub    $0x8,%esp
     7fb:	68 81 3e 00 00       	push   $0x3e81
     800:	ff 35 34 5c 00 00    	push   0x5c34
     806:	e8 f2 30 00 00       	call   38fd <printf>
    exit();
     80b:	e8 08 2f 00 00       	call   3718 <exit>
    printf(stdout, "chdir .. failed\n");
     810:	83 ec 08             	sub    $0x8,%esp
     813:	68 94 3e 00 00       	push   $0x3e94
     818:	ff 35 34 5c 00 00    	push   0x5c34
     81e:	e8 da 30 00 00       	call   38fd <printf>
    exit();
     823:	e8 f0 2e 00 00       	call   3718 <exit>
    printf(stdout, "unlink dir0 failed\n");
     828:	83 ec 08             	sub    $0x8,%esp
     82b:	68 a5 3e 00 00       	push   $0x3ea5
     830:	ff 35 34 5c 00 00    	push   0x5c34
     836:	e8 c2 30 00 00       	call   38fd <printf>
    exit();
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     ...
     84b:	ff 35 34 5c 00 00    	push   0x5c34
     851:	e8 a7 30 00 00       	call   38fd <printf>
  if(exec("echo", echoargv) < 0){
     856:	83 c4 08             	add    $0x8,%esp
     859:	68 38 5c 00 00       	push   $0x5c38
    ...
    printf(stdout, "exec echo failed\n");
     ...
     879:	ff 35 34 5c 00 00    	push   0x5c34
     87f:	e8 79 30 00 00       	call   38fd <printf>
    exit();
...
pipe1(void)
{
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     8d5:	68 80 83 00 00       	push   $0x8380
     ...
     8fb:	0f be 98 80 83 00 00 	movsbl 0x8380(%eax),%ebx
    ...
    printf(1, "pipe() failed\n");
     ...
     91e:	6a 01                	push   $0x1
     920:	e8 d8 2f 00 00       	call   38fd <printf>
    exit();
  ...
  seq = 0;
    ...
    for(n = 0; n < 5; n++){
     93c:	eb 35                	jmp    973 <pipe1+0xea>
        buf[i] = seq++;
     93e:	88 98 80 83 00 00    	mov    %bl,0x8380(%eax)
      for(i = 0; i < 1033; i++)
     ...
     959:	68 80 83 00 00       	push   $0x8380
    ...
    for(n = 0; n < 5; n++){
     ...
     984:	6a 01                	push   $0x1
     986:	e8 72 2f 00 00       	call   38fd <printf>
        exit();
    ...
    exit();
     ...
     99d:	6a 01                	push   $0x1
     99f:	e8 59 2f 00 00       	call   38fd <printf>
          return;
  ...
  printf(1, "pipe1 ok\n");
     ...
     9f2:	6a 01                	push   $0x1
     9f4:	e8 04 2f 00 00       	call   38fd <printf>
     ...
     a09:	6a 01                	push   $0x1
     a0b:	e8 ed 2e 00 00       	call   38fd <printf>
      exit();
    ...
    printf(1, "fork() failed\n");
     ...
     a1d:	6a 01                	push   $0x1
     a1f:	e8 d9 2e 00 00       	call   38fd <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     ...
     a37:	6a 01                	push   $0x1
     a39:	e8 bf 2e 00 00       	call   38fd <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    for(;;)
     ...
     ab2:	6a 01                	push   $0x1
     ab4:	e8 44 2e 00 00       	call   38fd <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     ad1:	68 80 83 00 00       	push   $0x8380
    ...
    printf(1, "preempt read error");
     ...
     aee:	6a 01                	push   $0x1
     af0:	e8 08 2e 00 00       	call   38fd <printf>
    return;
  ...
  printf(1, "kill... ");
     ...
     b13:	6a 01                	push   $0x1
     b15:	e8 e3 2d 00 00       	call   38fd <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     ...
     b3a:	6a 01                	push   $0x1
     b3c:	e8 bc 2d 00 00       	call   38fd <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ...
     b58:	6a 01                	push   $0x1
     b5a:	e8 9e 2d 00 00       	call   38fd <printf>
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
     ...
     b96:	6a 01                	push   $0x1
     b98:	e8 60 2d 00 00       	call   38fd <printf>
      return;
  ...
  printf(1, "exitwait ok\n");
     ...
     baf:	6a 01                	push   $0x1
     bb1:	e8 47 2d 00 00       	call   38fd <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     bc8:	6a 01                	push   $0x1
     bca:	e8 2e 2d 00 00       	call   38fd <printf>
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     ...
     be2:	6a 01                	push   $0x1
     be4:	e8 14 2d 00 00       	call   38fd <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     c13:	e8 0b 2f 00 00       	call   3b23 <malloc>
    ...
    while(m1){
     ...
     c26:	53                   	push   %ebx
     c27:	e8 37 2e 00 00       	call   3a63 <free>
    ...
    m1 = malloc(1024*20);
     ...
     c3d:	e8 e1 2e 00 00       	call   3b23 <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     c4c:	50                   	push   %eax
     c4d:	e8 11 2e 00 00       	call   3a63 <free>
    printf(1, "mem ok\n");
     c52:	83 c4 08             	add    $0x8,%esp
     c55:	68 d0 3f 00 00       	push   $0x3fd0
     c5a:	6a 01                	push   $0x1
     c5c:	e8 9c 2c 00 00       	call   38fd <printf>
    exit();
     ...
     c6e:	6a 01                	push   $0x1
     c70:	e8 88 2c 00 00       	call   38fd <printf>
      kill(ppid);
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     ...
     c9d:	6a 01                	push   $0x1
     c9f:	e8 59 2c 00 00       	call   38fd <printf>
  ...
  for(i = 0; i < 1000; i++){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     d1e:	6a 01                	push   $0x1
     d20:	e8 d8 2b 00 00       	call   38fd <printf>
    return;
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
     ...
     d3c:	6a 01                	push   $0x1
     d3e:	e8 ba 2b 00 00       	call   38fd <printf>
      break;
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     da4:	6a 01                	push   $0x1
     da6:	e8 52 2b 00 00       	call   38fd <printf>
    return;
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     e07:	6a 01                	push   $0x1
     e09:	e8 ef 2a 00 00       	call   38fd <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     e20:	6a 01                	push   $0x1
     e22:	e8 d6 2a 00 00       	call   38fd <printf>
    exit();
...
fourfiles(void)
{
  ...
  printf(1, "fourfiles test\n");
     ...
     e56:	6a 01                	push   $0x1
     e58:	e8 a0 2a 00 00       	call   38fd <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    if(pid < 0){
     ...
     e6f:	6a 01                	push   $0x1
     e71:	e8 87 2a 00 00       	call   38fd <printf>
      exit();
    ...
    if(pid == 0){
     ...
     e83:	6a 01                	push   $0x1
     e85:	e8 73 2a 00 00       	call   38fd <printf>
        exit();
     ...
     e98:	6a 01                	push   $0x1
     e9a:	e8 5e 2a 00 00       	call   38fd <printf>
          exit();
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    if(pid == 0){
     ...
     ef0:	56                   	push   %esi
     ef1:	68 80 83 00 00       	push   $0x8380
     ...
     f0b:	68 80 83 00 00       	push   $0x8380
     f10:	57                   	push   %edi
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	6a 01                	push   $0x1
     f4e:	e8 aa 29 00 00       	call   38fd <printf>
          exit();
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f63:	68 80 83 00 00       	push   $0x8380
     f68:	56                   	push   %esi
     ...
     f7e:	7d d8                	jge    f58 <fourfiles+0x12c>
        if(buf[j] != '0'+i){
     f80:	0f be 88 80 83 00 00 	movsbl 0x8380(%eax),%ecx
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     fec:	6a 01                	push   $0x1
     fee:	e8 0a 29 00 00       	call   38fd <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    ...
    1000:	6a 01                	push   $0x1
    1002:	e8 f6 28 00 00       	call   38fd <printf>
}
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    ...
    101f:	6a 01                	push   $0x1
    1021:	e8 d7 28 00 00       	call   38fd <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1051:	6a 01                	push   $0x1
    1053:	e8 a5 28 00 00       	call   38fd <printf>
      exit();
    ...
    1071:	6a 01                	push   $0x1
    1073:	e8 85 28 00 00       	call   38fd <printf>
          exit();
    ...
    10e2:	6a 01                	push   $0x1
    10e4:	e8 14 28 00 00       	call   38fd <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    116d:	6a 01                	push   $0x1
    116f:	e8 89 27 00 00       	call   38fd <printf>
        exit();
    ...
    1189:	6a 01                	push   $0x1
    118b:	e8 6d 27 00 00       	call   38fd <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    ...
    11f6:	6a 01                	push   $0x1
    11f8:	e8 00 27 00 00       	call   38fd <printf>
}
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1214:	6a 01                	push   $0x1
    1216:	e8 e2 26 00 00       	call   38fd <printf>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    12ba:	68 80 83 00 00       	push   $0x8380
    12bf:	53                   	push   %ebx
  ...
  if(buf[0] != 'h'){
    12d1:	80 3d 80 83 00 00 68 	cmpb   $0x68,0x8380
  ...
  if(write(fd, buf, 10) != 10){
    ...
    12e1:	6a 0a                	push   $0xa
    12e3:	68 80 83 00 00       	push   $0x8380
    12e8:	53                   	push   %ebx
  ...
  printf(1, "unlinkread ok\n");
    ...
    1317:	6a 01                	push   $0x1
    1319:	e8 df 25 00 00       	call   38fd <printf>
}
    ...
    1330:	6a 01                	push   $0x1
    1332:	e8 c6 25 00 00       	call   38fd <printf>
    exit();
    ...
    1344:	6a 01                	push   $0x1
    1346:	e8 b2 25 00 00       	call   38fd <printf>
    exit();
    ...
    1358:	6a 01                	push   $0x1
    135a:	e8 9e 25 00 00       	call   38fd <printf>
    exit();
    ...
    136c:	6a 01                	push   $0x1
    136e:	e8 8a 25 00 00       	call   38fd <printf>
    exit();
    ...
    1380:	6a 01                	push   $0x1
    1382:	e8 76 25 00 00       	call   38fd <printf>
    exit();
    ...
    1394:	6a 01                	push   $0x1
    1396:	e8 62 25 00 00       	call   38fd <printf>
    exit();
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    ...
    13ac:	6a 01                	push   $0x1
    13ae:	e8 4a 25 00 00       	call   38fd <printf>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1477:	68 80 83 00 00       	push   $0x8380
    147c:	50                   	push   %eax
  ...
  printf(1, "linktest ok\n");
    ...
    1503:	6a 01                	push   $0x1
    1505:	e8 f3 23 00 00       	call   38fd <printf>
}
    ...
    151a:	6a 01                	push   $0x1
    151c:	e8 dc 23 00 00       	call   38fd <printf>
    exit();
    ...
    152e:	6a 01                	push   $0x1
    1530:	e8 c8 23 00 00       	call   38fd <printf>
    exit();
    ...
    1542:	6a 01                	push   $0x1
    1544:	e8 b4 23 00 00       	call   38fd <printf>
    exit();
    ...
    1556:	6a 01                	push   $0x1
    1558:	e8 a0 23 00 00       	call   38fd <printf>
    exit();
    ...
    156a:	6a 01                	push   $0x1
    156c:	e8 8c 23 00 00       	call   38fd <printf>
    exit();
    ...
    157e:	6a 01                	push   $0x1
    1580:	e8 78 23 00 00       	call   38fd <printf>
    exit();
    ...
    1592:	6a 01                	push   $0x1
    1594:	e8 64 23 00 00       	call   38fd <printf>
    exit();
    ...
    15a6:	6a 01                	push   $0x1
    15a8:	e8 50 23 00 00       	call   38fd <printf>
    exit();
    ...
    15ba:	6a 01                	push   $0x1
    15bc:	e8 3c 23 00 00       	call   38fd <printf>
    exit();
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    ...
    15d4:	6a 01                	push   $0x1
    15d6:	e8 22 23 00 00       	call   38fd <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    16d3:	6a 01                	push   $0x1
    16d5:	e8 23 22 00 00       	call   38fd <printf>
        exit();
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    175f:	6a 01                	push   $0x1
    1761:	e8 97 21 00 00       	call   38fd <printf>
        exit();
    ...
    1777:	6a 01                	push   $0x1
    1779:	e8 7f 21 00 00       	call   38fd <printf>
        exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    17a6:	6a 01                	push   $0x1
    17a8:	e8 50 21 00 00       	call   38fd <printf>
    exit();
    ...
    17ba:	6a 01                	push   $0x1
    17bc:	e8 3c 21 00 00       	call   38fd <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    ...
    18a2:	6a 01                	push   $0x1
    18a4:	e8 54 20 00 00       	call   38fd <printf>
}
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    ...
    18c2:	6a 01                	push   $0x1
    18c4:	e8 34 20 00 00       	call   38fd <printf>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    18f9:	6a 01                	push   $0x1
    18fb:	e8 fd 1f 00 00       	call   38fd <printf>
    exit();
  ...
  printf(1, "linkunlink ok\n");
    ...
    1994:	6a 01                	push   $0x1
    1996:	e8 62 1f 00 00       	call   38fd <printf>
}
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    ...
    19b4:	6a 01                	push   $0x1
    19b6:	e8 42 1f 00 00       	call   38fd <printf>
  unlink("bd");
  ...
  for(i = 0; i < 500; i++){
    ...
    1a4d:	6a 01                	push   $0x1
    1a4f:	e8 a9 1e 00 00       	call   38fd <printf>
    exit();
    ...
    1a61:	6a 01                	push   $0x1
    1a63:	e8 95 1e 00 00       	call   38fd <printf>
      exit();
  ...
  for(i = 0; i < 500; i++){
    ...
    1ad9:	6a 01                	push   $0x1
    1adb:	e8 1d 1e 00 00       	call   38fd <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    ...
    1aed:	6a 01                	push   $0x1
    1aef:	e8 09 1e 00 00       	call   38fd <printf>
}
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    ...
    1b08:	6a 01                	push   $0x1
    1b0a:	e8 ee 1d 00 00       	call   38fd <printf>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1bf3:	68 80 83 00 00       	push   $0x8380
    1bf8:	50                   	push   %eax
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1c0a:	80 3d 80 83 00 00 66 	cmpb   $0x66,0x8380
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1cf3:	68 80 83 00 00       	push   $0x8380
    1cf8:	50                   	push   %eax
  ...
  printf(1, "subdir ok\n");
    ...
    1f37:	6a 01                	push   $0x1
    1f39:	e8 bf 19 00 00       	call   38fd <printf>
}
    ...
    1f4e:	6a 01                	push   $0x1
    1f50:	e8 a8 19 00 00       	call   38fd <printf>
    exit();
    ...
    1f62:	6a 01                	push   $0x1
    1f64:	e8 94 19 00 00       	call   38fd <printf>
    exit();
    ...
    1f76:	6a 01                	push   $0x1
    1f78:	e8 80 19 00 00       	call   38fd <printf>
    exit();
    ...
    1f8a:	6a 01                	push   $0x1
    1f8c:	e8 6c 19 00 00       	call   38fd <printf>
    exit();
    ...
    1f9e:	6a 01                	push   $0x1
    1fa0:	e8 58 19 00 00       	call   38fd <printf>
    exit();
    ...
    1fb2:	6a 01                	push   $0x1
    1fb4:	e8 44 19 00 00       	call   38fd <printf>
    exit();
    ...
    1fc6:	6a 01                	push   $0x1
    1fc8:	e8 30 19 00 00       	call   38fd <printf>
    exit();
    ...
    1fda:	6a 01                	push   $0x1
    1fdc:	e8 1c 19 00 00       	call   38fd <printf>
    exit();
    ...
    1fee:	6a 01                	push   $0x1
    1ff0:	e8 08 19 00 00       	call   38fd <printf>
    exit();
    ...
    2002:	6a 01                	push   $0x1
    2004:	e8 f4 18 00 00       	call   38fd <printf>
    exit();
    ...
    2016:	6a 01                	push   $0x1
    2018:	e8 e0 18 00 00       	call   38fd <printf>
    exit();
    ...
    202a:	6a 01                	push   $0x1
    202c:	e8 cc 18 00 00       	call   38fd <printf>
    exit();
    ...
    203e:	6a 01                	push   $0x1
    2040:	e8 b8 18 00 00       	call   38fd <printf>
    exit();
    ...
    2052:	6a 01                	push   $0x1
    2054:	e8 a4 18 00 00       	call   38fd <printf>
    exit();
    ...
    2066:	6a 01                	push   $0x1
    2068:	e8 90 18 00 00       	call   38fd <printf>
    exit();
    ...
    207a:	6a 01                	push   $0x1
    207c:	e8 7c 18 00 00       	call   38fd <printf>
    exit();
    ...
    208e:	6a 01                	push   $0x1
    2090:	e8 68 18 00 00       	call   38fd <printf>
    exit();
    ...
    20a2:	6a 01                	push   $0x1
    20a4:	e8 54 18 00 00       	call   38fd <printf>
    exit();
    ...
    20b6:	6a 01                	push   $0x1
    20b8:	e8 40 18 00 00       	call   38fd <printf>
    exit();
    ...
    20ca:	6a 01                	push   $0x1
    20cc:	e8 2c 18 00 00       	call   38fd <printf>
    exit();
    ...
    20de:	6a 01                	push   $0x1
    20e0:	e8 18 18 00 00       	call   38fd <printf>
    exit();
    ...
    20f2:	6a 01                	push   $0x1
    20f4:	e8 04 18 00 00       	call   38fd <printf>
    exit();
    ...
    2106:	6a 01                	push   $0x1
    2108:	e8 f0 17 00 00       	call   38fd <printf>
    exit();
    ...
    211a:	6a 01                	push   $0x1
    211c:	e8 dc 17 00 00       	call   38fd <printf>
    exit();
    ...
    212e:	6a 01                	push   $0x1
    2130:	e8 c8 17 00 00       	call   38fd <printf>
    exit();
    ...
    2142:	6a 01                	push   $0x1
    2144:	e8 b4 17 00 00       	call   38fd <printf>
    exit();
    ...
    2156:	6a 01                	push   $0x1
    2158:	e8 a0 17 00 00       	call   38fd <printf>
    exit();
    ...
    216a:	6a 01                	push   $0x1
    216c:	e8 8c 17 00 00       	call   38fd <printf>
    exit();
    ...
    217e:	6a 01                	push   $0x1
    2180:	e8 78 17 00 00       	call   38fd <printf>
    exit();
    ...
    2192:	6a 01                	push   $0x1
    2194:	e8 64 17 00 00       	call   38fd <printf>
    exit();
    ...
    21a6:	6a 01                	push   $0x1
    21a8:	e8 50 17 00 00       	call   38fd <printf>
    exit();
    ...
    21ba:	6a 01                	push   $0x1
    21bc:	e8 3c 17 00 00       	call   38fd <printf>
    exit();
    ...
    21ce:	6a 01                	push   $0x1
    21d0:	e8 28 17 00 00       	call   38fd <printf>
    exit();
    ...
    21e2:	6a 01                	push   $0x1
    21e4:	e8 14 17 00 00       	call   38fd <printf>
    exit();
    ...
    21f6:	6a 01                	push   $0x1
    21f8:	e8 00 17 00 00       	call   38fd <printf>
    exit();
    ...
    220a:	6a 01                	push   $0x1
    220c:	e8 ec 16 00 00       	call   38fd <printf>
    exit();
    ...
    221e:	6a 01                	push   $0x1
    2220:	e8 d8 16 00 00       	call   38fd <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    ...
    2238:	6a 01                	push   $0x1
    223a:	e8 be 16 00 00       	call   38fd <printf>
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    225d:	6a 01                	push   $0x1
    225f:	e8 99 16 00 00       	call   38fd <printf>
      exit();
    ...
    2270:	6a 01                	push   $0x1
    2272:	e8 86 16 00 00       	call   38fd <printf>
        exit();
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    22ca:	56                   	push   %esi
    22cb:	68 80 83 00 00       	push   $0x8380
    22d0:	57                   	push   %edi
  ...
  printf(1, "bigwrite ok\n");
    ...
    22ea:	6a 01                	push   $0x1
    22ec:	e8 0c 16 00 00       	call   38fd <printf>
}
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    ...
    230a:	6a 01                	push   $0x1
    230c:	e8 ec 15 00 00       	call   38fd <printf>
  ...
  for(i = 0; i < 20; i++){
    ...
    237f:	6a 01                	push   $0x1
    2381:	e8 77 15 00 00       	call   38fd <printf>
    exit();
    ...
    2393:	6a 01                	push   $0x1
    2395:	e8 63 15 00 00       	call   38fd <printf>
      exit();
  ...
  for(i = 0; ; i++){
    ...
    23d2:	68 80 83 00 00       	push   $0x8380
    23d7:	57                   	push   %edi
    ...
    23ed:	0f be 0d 80 83 00 00 	movsbl 0x8380,%ecx
    ...
    2401:	0f be 0d ab 84 00 00 	movsbl 0x84ab,%ecx
  ...
  for(i = 0; ; i++){
    ...
    241b:	6a 01                	push   $0x1
    241d:	e8 db 14 00 00       	call   38fd <printf>
    exit();
    ...
    242f:	6a 01                	push   $0x1
    2431:	e8 c7 14 00 00       	call   38fd <printf>
      exit();
    ...
    2443:	6a 01                	push   $0x1
    2445:	e8 b3 14 00 00       	call   38fd <printf>
      exit();
    ...
    2457:	6a 01                	push   $0x1
    2459:	e8 9f 14 00 00       	call   38fd <printf>
      exit();
  ...
  printf(1, "bigfile test ok\n");
    ...
    248c:	6a 01                	push   $0x1
    248e:	e8 6a 14 00 00       	call   38fd <printf>
}
    ...
    24a6:	6a 01                	push   $0x1
    24a8:	e8 50 14 00 00       	call   38fd <printf>
    exit();
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    ...
    24bd:	6a 01                	push   $0x1
    24bf:	e8 39 14 00 00       	call   38fd <printf>
  ...
  printf(1, "fourteen ok\n");
    ...
    256b:	6a 01                	push   $0x1
    256d:	e8 8b 13 00 00       	call   38fd <printf>
}
    ...
    257f:	6a 01                	push   $0x1
    2581:	e8 77 13 00 00       	call   38fd <printf>
    exit();
    ...
    2593:	6a 01                	push   $0x1
    2595:	e8 63 13 00 00       	call   38fd <printf>
    exit();
    ...
    25a7:	6a 01                	push   $0x1
    25a9:	e8 4f 13 00 00       	call   38fd <printf>
    exit();
    ...
    25bb:	6a 01                	push   $0x1
    25bd:	e8 3b 13 00 00       	call   38fd <printf>
    exit();
    ...
    25cf:	6a 01                	push   $0x1
    25d1:	e8 27 13 00 00       	call   38fd <printf>
    exit();
    ...
    25e3:	6a 01                	push   $0x1
    25e5:	e8 13 13 00 00       	call   38fd <printf>
    exit();
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    ...
    25fa:	6a 01                	push   $0x1
    25fc:	e8 fc 12 00 00       	call   38fd <printf>
  if(mkdir("dots") != 0){
  ...
  printf(1, "rmdot ok\n");
    ...
    26c8:	6a 01                	push   $0x1
    26ca:	e8 2e 12 00 00       	call   38fd <printf>
}
    ...
    26dc:	6a 01                	push   $0x1
    26de:	e8 1a 12 00 00       	call   38fd <printf>
    exit();
    ...
    26f0:	6a 01                	push   $0x1
    26f2:	e8 06 12 00 00       	call   38fd <printf>
    exit();
    ...
    2704:	6a 01                	push   $0x1
    2706:	e8 f2 11 00 00       	call   38fd <printf>
    exit();
    ...
    2718:	6a 01                	push   $0x1
    271a:	e8 de 11 00 00       	call   38fd <printf>
    exit();
    ...
    272c:	6a 01                	push   $0x1
    272e:	e8 ca 11 00 00       	call   38fd <printf>
    exit();
    ...
    2740:	6a 01                	push   $0x1
    2742:	e8 b6 11 00 00       	call   38fd <printf>
    exit();
    ...
    2754:	6a 01                	push   $0x1
    2756:	e8 a2 11 00 00       	call   38fd <printf>
    exit();
    ...
    2768:	6a 01                	push   $0x1
    276a:	e8 8e 11 00 00       	call   38fd <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    ...
    2780:	6a 01                	push   $0x1
    2782:	e8 76 11 00 00       	call   38fd <printf>
  ...
  printf(1, "dir vs file OK\n");
    ...
    28b7:	6a 01                	push   $0x1
    28b9:	e8 3f 10 00 00       	call   38fd <printf>
}
    ...
    28ce:	6a 01                	push   $0x1
    28d0:	e8 28 10 00 00       	call   38fd <printf>
    exit();
    ...
    28e2:	6a 01                	push   $0x1
    28e4:	e8 14 10 00 00       	call   38fd <printf>
    exit();
    ...
    28f6:	6a 01                	push   $0x1
    28f8:	e8 00 10 00 00       	call   38fd <printf>
    exit();
    ...
    290a:	6a 01                	push   $0x1
    290c:	e8 ec 0f 00 00       	call   38fd <printf>
    exit();
    ...
    291e:	6a 01                	push   $0x1
    2920:	e8 d8 0f 00 00       	call   38fd <printf>
    exit();
    ...
    2932:	6a 01                	push   $0x1
    2934:	e8 c4 0f 00 00       	call   38fd <printf>
    exit();
    ...
    2946:	6a 01                	push   $0x1
    2948:	e8 b0 0f 00 00       	call   38fd <printf>
    exit();
    ...
    295a:	6a 01                	push   $0x1
    295c:	e8 9c 0f 00 00       	call   38fd <printf>
    exit();
    ...
    296e:	6a 01                	push   $0x1
    2970:	e8 88 0f 00 00       	call   38fd <printf>
    exit();
    ...
    2982:	6a 01                	push   $0x1
    2984:	e8 74 0f 00 00       	call   38fd <printf>
    exit();
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    ...
    299a:	6a 01                	push   $0x1
    299c:	e8 5c 0f 00 00       	call   38fd <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    29b3:	6a 01                	push   $0x1
    29b5:	e8 43 0f 00 00       	call   38fd <printf>
      exit();
    ...
    29c7:	6a 01                	push   $0x1
    29c9:	e8 2f 0f 00 00       	call   38fd <printf>
      exit();
  ...
  printf(1, "empty file name OK\n");
    ...
    2aa7:	6a 01                	push   $0x1
    2aa9:	e8 4f 0e 00 00       	call   38fd <printf>
}
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    ...
    2ac2:	6a 01                	push   $0x1
    2ac4:	e8 34 0e 00 00       	call   38fd <printf>
  ...
  for(; n > 0; n--){
    ...
    2b10:	6a 01                	push   $0x1
    2b12:	e8 e6 0d 00 00       	call   38fd <printf>
    exit();
    ...
    2b24:	6a 01                	push   $0x1
    2b26:	e8 d2 0d 00 00       	call   38fd <printf>
      exit();
  ...
  printf(1, "fork test OK\n");
    ...
    2b42:	6a 01                	push   $0x1
    2b44:	e8 b4 0d 00 00       	call   38fd <printf>
}
    ...
    2b59:	6a 01                	push   $0x1
    2b5b:	e8 9d 0d 00 00       	call   38fd <printf>
    exit();
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2b73:	ff 35 34 5c 00 00    	push   0x5c34
    2b79:	e8 7f 0d 00 00       	call   38fd <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){
    ...
    2bd1:	ff 35 34 5c 00 00    	push   0x5c34
    2bd7:	e8 21 0d 00 00       	call   38fd <printf>
      exit();
...
//  *lastaddr = 99;
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2d47:	ff 35 34 5c 00 00    	push   0x5c34
    2d4d:	e8 ab 0b 00 00       	call   38fd <printf>
    exit();
    2d52:	e8 c1 09 00 00       	call   3718 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    2d57:	83 ec 08             	sub    $0x8,%esp
    2d5a:	68 d9 49 00 00       	push   $0x49d9
    2d5f:	ff 35 34 5c 00 00    	push   0x5c34
    2d65:	e8 93 0b 00 00       	call   38fd <printf>
    exit();
    ...
    2d7c:	ff 35 34 5c 00 00    	push   0x5c34
    2d82:	e8 76 0b 00 00       	call   38fd <printf>
    exit();
    2d87:	e8 8c 09 00 00       	call   3718 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    2d8c:	83 ec 08             	sub    $0x8,%esp
    2d8f:	68 f5 49 00 00       	push   $0x49f5
    2d94:	ff 35 34 5c 00 00    	push   0x5c34
    2d9a:	e8 5e 0b 00 00       	call   38fd <printf>
    exit();
    ...
    2dab:	ff 35 34 5c 00 00    	push   0x5c34
    2db1:	e8 47 0b 00 00       	call   38fd <printf>
    exit();
    ...
    2dc2:	ff 35 34 5c 00 00    	push   0x5c34
    2dc8:	e8 30 0b 00 00       	call   38fd <printf>
    exit();
    2dcd:	e8 46 09 00 00       	call   3718 <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    2dd2:	83 ec 08             	sub    $0x8,%esp
    2dd5:	68 c0 51 00 00       	push   $0x51c0
    2dda:	ff 35 34 5c 00 00    	push   0x5c34
    2de0:	e8 18 0b 00 00       	call   38fd <printf>
    exit();
    ...
    2df1:	ff 35 34 5c 00 00    	push   0x5c34
    2df7:	e8 01 0b 00 00       	call   38fd <printf>
    exit();
    2dfc:	e8 17 09 00 00       	call   3718 <exit>
      printf(stdout, "fork failed\n");
    2e01:	83 ec 08             	sub    $0x8,%esp
    2e04:	68 ed 4a 00 00       	push   $0x4aed
    2e09:	ff 35 34 5c 00 00    	push   0x5c34
    2e0f:	e8 e9 0a 00 00       	call   38fd <printf>
      exit();
    ...
    2e23:	ff 35 34 5c 00 00    	push   0x5c34
    2e29:	e8 cf 0a 00 00       	call   38fd <printf>
      kill(ppid);
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2e5c:	6a 01                	push   $0x1
    2e5e:	e8 9a 0a 00 00       	call   38fd <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2f30:	ff 35 34 5c 00 00    	push   0x5c34
    2f36:	e8 c2 09 00 00       	call   38fd <printf>
}
    ...
    2f4e:	ff 35 34 5c 00 00    	push   0x5c34
    2f54:	e8 a4 09 00 00       	call   38fd <printf>
    exit();
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    ...
    2f85:	ff 35 34 5c 00 00    	push   0x5c34
    2f8b:	e8 6d 09 00 00       	call   38fd <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    2ff9:	ff 35 34 5c 00 00    	push   0x5c34
    2fff:	e8 f9 08 00 00       	call   38fd <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    ...
    3011:	ff 35 34 5c 00 00    	push   0x5c34
    3017:	e8 e1 08 00 00       	call   38fd <printf>
}
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    ...
    3031:	ff 35 34 5c 00 00    	push   0x5c34
    3037:	e8 c1 08 00 00       	call   38fd <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    if(uninit[i] != '\0'){
    304b:	80 b8 60 5c 00 00 00 	cmpb   $0x0,0x5c60(%eax)
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3061:	ff 35 34 5c 00 00    	push   0x5c34
    3067:	e8 91 08 00 00       	call   38fd <printf>
      exit();
  ...
  printf(stdout, "bss test ok\n");
    ...
    3079:	ff 35 34 5c 00 00    	push   0x5c34
    307f:	e8 79 08 00 00       	call   38fd <printf>
}
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    ...
    30e4:	c7 04 85 80 a3 00 00 	movl   $0x5214,0xa380(,%eax,4)
    30eb:	14 52 00 00 
    ...
    args[MAXARG-1] = 0;
    30f7:	c7 05 fc a3 00 00 00 	movl   $0x0,0xa3fc
    30fe:	00 00 00 
    printf(stdout, "bigarg test\n");
    3101:	83 ec 08             	sub    $0x8,%esp
    3104:	68 c4 4a 00 00       	push   $0x4ac4
    3109:	ff 35 34 5c 00 00    	push   0x5c34
    310f:	e8 e9 07 00 00       	call   38fd <printf>
    exec("echo", args);
    3114:	83 c4 08             	add    $0x8,%esp
    3117:	68 80 a3 00 00       	push   $0xa380
    ...
    312e:	ff 35 34 5c 00 00    	push   0x5c34
    3134:	e8 c4 07 00 00       	call   38fd <printf>
    fd = open("bigarg-ok", O_CREATE);
    ...
    3160:	ff 35 34 5c 00 00    	push   0x5c34
    3166:	e8 92 07 00 00       	call   38fd <printf>
    exit();
    316b:	e8 a8 05 00 00       	call   3718 <exit>
    printf(stdout, "bigarg test failed!\n");
    3170:	83 ec 08             	sub    $0x8,%esp
    3173:	68 fa 4a 00 00       	push   $0x4afa
    3178:	ff 35 34 5c 00 00    	push   0x5c34
    317e:	e8 7a 07 00 00       	call   38fd <printf>
    exit();
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    ...
    3196:	6a 01                	push   $0x1
    3198:	e8 60 07 00 00       	call   38fd <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3234:	6a 01                	push   $0x1
    3236:	e8 c2 06 00 00       	call   38fd <printf>
    ...
    325e:	6a 01                	push   $0x1
    3260:	e8 98 06 00 00       	call   38fd <printf>
      break;
    ...
    327a:	68 80 83 00 00       	push   $0x8380
    327f:	56                   	push   %esi
    ...
    329c:	6a 01                	push   $0x1
    329e:	e8 5a 06 00 00       	call   38fd <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    ...
    3363:	6a 01                	push   $0x1
    3365:	e8 93 05 00 00       	call   38fd <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    ...
    3380:	6a 01                	push   $0x1
    3382:	e8 76 05 00 00       	call   38fd <printf>
  pid = fork();
  ...
  printf(1, "uio test done\n");
    ...
    33a2:	6a 01                	push   $0x1
    33a4:	e8 54 05 00 00       	call   38fd <printf>
}
    ...
    33c7:	6a 01                	push   $0x1
    33c9:	e8 2f 05 00 00       	call   38fd <printf>
    exit();
    ...
    33db:	6a 01                	push   $0x1
    33dd:	e8 1b 05 00 00       	call   38fd <printf>
    exit();
...
void argptest()
{
  ...
  printf(1, "arg test passed\n");
    ...
    342c:	6a 01                	push   $0x1
    342e:	e8 ca 04 00 00       	call   38fd <printf>
}
    ...
    3443:	6a 02                	push   $0x2
    3445:	e8 b3 04 00 00       	call   38fd <printf>
    exit();
...
rand()
{
  randstate = randstate * 1664525 + 1013904223;
    344f:	69 05 30 5c 00 00 0d 	imul   $0x19660d,0x5c30,%eax
    3456:	66 19 00 
    3459:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    345e:	a3 30 5c 00 00       	mov    %eax,0x5c30
  return randstate;
}
    3463:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    ...
    347a:	6a 01                	push   $0x1
    347c:	e8 7c 04 00 00       	call   38fd <printf>
  ...
  if(open("usertests.ran", 0) >= 0){
    ...
    349f:	6a 01                	push   $0x1
    34a1:	e8 57 04 00 00       	call   38fd <printf>
    exit();
...
00003838 <init_mylock>:
SYSCALL(init_mylock)
    3838:	b8 26 00 00 00       	mov    $0x26,%eax
    383d:	cd 40                	int    $0x40
    383f:	c3                   	ret    

00003840 <acquire_mylock>:
SYSCALL(acquire_mylock)
    3840:	b8 27 00 00 00       	mov    $0x27,%eax
    3845:	cd 40                	int    $0x40
    3847:	c3                   	ret    

00003848 <release_mylock>:
SYSCALL(release_mylock)
    3848:	b8 28 00 00 00       	mov    $0x28,%eax
    384d:	cd 40                	int    $0x40
    384f:	c3                   	ret    

00003850 <holding_mylock>:
    3850:	b8 29 00 00 00       	mov    $0x29,%eax
    3855:	cd 40                	int    $0x40
    3857:	c3                   	ret    
...
{
    3858:	55                   	push   %ebp
    3859:	89 e5                	mov    %esp,%ebp
    385b:	83 ec 1c             	sub    $0x1c,%esp
    385e:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
    3861:	6a 01                	push   $0x1
    3863:	8d 55 f4             	lea    -0xc(%ebp),%edx
    3866:	52                   	push   %edx
    3867:	50                   	push   %eax
    3868:	e8 cb fe ff ff       	call   3738 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    3876:	56                   	push   %esi
    3877:	53                   	push   %ebx
    3878:	83 ec 2c             	sub    $0x2c,%esp
    387b:	89 45 d0             	mov    %eax,-0x30(%ebp)
    387e:	89 d0                	mov    %edx,%eax
    3880:	89 ce                	mov    %ecx,%esi
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    3882:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    3886:	0f 95 c1             	setne  %cl
    3889:	c1 ea 1f             	shr    $0x1f,%edx
    388c:	84 d1                	test   %dl,%cl
    388e:	74 44                	je     38d4 <printint+0x62>
    neg = 1;
    x = -xx;
    3890:	f7 d8                	neg    %eax
    3892:	89 c1                	mov    %eax,%ecx
    neg = 1;
    3894:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
    389b:	bb 00 00 00 00       	mov    $0x0,%ebx
  do{
    buf[i++] = digits[x % base];
    38a0:	89 c8                	mov    %ecx,%eax
    38a2:	ba 00 00 00 00       	mov    $0x0,%edx
    38a7:	f7 f6                	div    %esi
    38a9:	89 df                	mov    %ebx,%edi
    38ab:	83 c3 01             	add    $0x1,%ebx
    38ae:	0f b6 92 a4 53 00 00 	movzbl 0x53a4(%edx),%edx
    38b5:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
    38b9:	89 ca                	mov    %ecx,%edx
    38bb:	89 c1                	mov    %eax,%ecx
    38bd:	39 d6                	cmp    %edx,%esi
    38bf:	76 df                	jbe    38a0 <printint+0x2e>
  if(neg)
    38c1:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
    38c5:	74 31                	je     38f8 <printint+0x86>
    buf[i++] = '-';
    38c7:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
    38cc:	8d 5f 02             	lea    0x2(%edi),%ebx
    38cf:	8b 75 d0             	mov    -0x30(%ebp),%esi
    38d2:	eb 17                	jmp    38eb <printint+0x79>
    x = xx;
    38d4:	89 c1                	mov    %eax,%ecx
  neg = 0;
    38d6:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
    38dd:	eb bc                	jmp    389b <printint+0x29>

  while(--i >= 0)
    putc(fd, buf[i]);
    38df:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
    38e4:	89 f0                	mov    %esi,%eax
    38e6:	e8 6d ff ff ff       	call   3858 <putc>
  while(--i >= 0)
    38eb:	83 eb 01             	sub    $0x1,%ebx
    38ee:	79 ef                	jns    38df <printint+0x6d>
}
    38f0:	83 c4 2c             	add    $0x2c,%esp
    38f3:	5b                   	pop    %ebx
    38f4:	5e                   	pop    %esi
    38f5:	5f                   	pop    %edi
    38f6:	5d                   	pop    %ebp
    38f7:	c3                   	ret    
    38f8:	8b 75 d0             	mov    -0x30(%ebp),%esi
    38fb:	eb ee                	jmp    38eb <printint+0x79>
...
printf(int fd, const char *fmt, ...)
{
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
    3906:	8d 45 10             	lea    0x10(%ebp),%eax
    3909:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  state = 0;
    390c:	be 00 00 00 00       	mov    $0x0,%esi
  for(i = 0; fmt[i]; i++){
    3911:	bb 00 00 00 00       	mov    $0x0,%ebx
    3916:	eb 14                	jmp    392c <printf+0x2f>
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    ...
    391d:	e8 36 ff ff ff       	call   3858 <putc>
    3922:	eb 05                	jmp    3929 <printf+0x2c>
      }
    } else if(state == '%'){
    3924:	83 fe 25             	cmp    $0x25,%esi
    3927:	74 25                	je     394e <printf+0x51>
  for(i = 0; fmt[i]; i++){
    3929:	83 c3 01             	add    $0x1,%ebx
    392c:	8b 45 0c             	mov    0xc(%ebp),%eax
    392f:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
    3933:	84 c0                	test   %al,%al
    3935:	0f 84 20 01 00 00    	je     3a5b <printf+0x15e>
    c = fmt[i] & 0xff;
    393b:	0f be f8             	movsbl %al,%edi
    393e:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
    3941:	85 f6                	test   %esi,%esi
    3943:	75 df                	jne    3924 <printf+0x27>
      if(c == '%'){
    3945:	83 f8 25             	cmp    $0x25,%eax
    3948:	75 ce                	jne    3918 <printf+0x1b>
        state = '%';
    394a:	89 c6                	mov    %eax,%esi
    394c:	eb db                	jmp    3929 <printf+0x2c>
      if(c == 'd'){
    394e:	83 f8 25             	cmp    $0x25,%eax
    3951:	0f 84 cf 00 00 00    	je     3a26 <printf+0x129>
    3957:	0f 8c dd 00 00 00    	jl     3a3a <printf+0x13d>
    395d:	83 f8 78             	cmp    $0x78,%eax
    3960:	0f 8f d4 00 00 00    	jg     3a3a <printf+0x13d>
    3966:	83 f8 63             	cmp    $0x63,%eax
    3969:	0f 8c cb 00 00 00    	jl     3a3a <printf+0x13d>
    396f:	83 e8 63             	sub    $0x63,%eax
    3972:	83 f8 15             	cmp    $0x15,%eax
    3975:	0f 87 bf 00 00 00    	ja     3a3a <printf+0x13d>
    397b:	ff 24 85 4c 53 00 00 	jmp    *0x534c(,%eax,4)
        printint(fd, *ap, 10, 1);
    3982:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    3985:	8b 17                	mov    (%edi),%edx
    3987:	83 ec 0c             	sub    $0xc,%esp
    398a:	6a 01                	push   $0x1
    398c:	b9 0a 00 00 00       	mov    $0xa,%ecx
    3991:	8b 45 08             	mov    0x8(%ebp),%eax
    3994:	e8 d9 fe ff ff       	call   3872 <printint>
        ap++;
    3999:	83 c7 04             	add    $0x4,%edi
    399c:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    399f:	83 c4 10             	add    $0x10,%esp
      } else {
      ...
      state = 0;
    39a2:	be 00 00 00 00       	mov    $0x0,%esi
    39a7:	eb 80                	jmp    3929 <printf+0x2c>
        printint(fd, *ap, 16, 0);
    39a9:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    39ac:	8b 17                	mov    (%edi),%edx
    39ae:	83 ec 0c             	sub    $0xc,%esp
    39b1:	6a 00                	push   $0x0
    39b3:	b9 10 00 00 00       	mov    $0x10,%ecx
    39b8:	8b 45 08             	mov    0x8(%ebp),%eax
    39bb:	e8 b2 fe ff ff       	call   3872 <printint>
        ap++;
    39c0:	83 c7 04             	add    $0x4,%edi
    39c3:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    39c6:	83 c4 10             	add    $0x10,%esp
      state = 0;
    39c9:	be 00 00 00 00       	mov    $0x0,%esi
    39ce:	e9 56 ff ff ff       	jmp    3929 <printf+0x2c>
        s = (char*)*ap;
    39d3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    39d6:	8b 30                	mov    (%eax),%esi
        ap++;
    39d8:	83 c0 04             	add    $0x4,%eax
    39db:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
    39de:	85 f6                	test   %esi,%esi
    39e0:	75 15                	jne    39f7 <printf+0xfa>
          s = "(null)";
    39e2:	be 42 53 00 00       	mov    $0x5342,%esi
    39e7:	eb 0e                	jmp    39f7 <printf+0xfa>
          putc(fd, *s);
    39e9:	0f be d2             	movsbl %dl,%edx
    39ec:	8b 45 08             	mov    0x8(%ebp),%eax
    39ef:	e8 64 fe ff ff       	call   3858 <putc>
          s++;
    39f4:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
    39f7:	0f b6 16             	movzbl (%esi),%edx
    39fa:	84 d2                	test   %dl,%dl
    39fc:	75 eb                	jne    39e9 <printf+0xec>
      state = 0;
    39fe:	be 00 00 00 00       	mov    $0x0,%esi
    3a03:	e9 21 ff ff ff       	jmp    3929 <printf+0x2c>
        putc(fd, *ap);
    3a08:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    3a0b:	0f be 17             	movsbl (%edi),%edx
    3a0e:	8b 45 08             	mov    0x8(%ebp),%eax
    3a11:	e8 42 fe ff ff       	call   3858 <putc>
        ap++;
    3a16:	83 c7 04             	add    $0x4,%edi
    3a19:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
    3a1c:	be 00 00 00 00       	mov    $0x0,%esi
    3a21:	e9 03 ff ff ff       	jmp    3929 <printf+0x2c>
        putc(fd, c);
    3a26:	89 fa                	mov    %edi,%edx
    3a28:	8b 45 08             	mov    0x8(%ebp),%eax
    3a2b:	e8 28 fe ff ff       	call   3858 <putc>
      state = 0;
    3a30:	be 00 00 00 00       	mov    $0x0,%esi
    3a35:	e9 ef fe ff ff       	jmp    3929 <printf+0x2c>
        putc(fd, '%');
    3a3a:	ba 25 00 00 00       	mov    $0x25,%edx
    3a3f:	8b 45 08             	mov    0x8(%ebp),%eax
    3a42:	e8 11 fe ff ff       	call   3858 <putc>
        putc(fd, c);
    3a47:	89 fa                	mov    %edi,%edx
    3a49:	8b 45 08             	mov    0x8(%ebp),%eax
    3a4c:	e8 07 fe ff ff       	call   3858 <putc>
      state = 0;
    3a51:	be 00 00 00 00       	mov    $0x0,%esi
    3a56:	e9 ce fe ff ff       	jmp    3929 <printf+0x2c>
    }
  }
}
    3a5b:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3a5e:	5b                   	pop    %ebx
    3a5f:	5e                   	pop    %esi
    3a60:	5f                   	pop    %edi
    3a61:	5d                   	pop    %ebp
...
free(void *ap)
{
    ...
    3a67:	56                   	push   %esi
    3a68:	53                   	push   %ebx
    3a69:	8b 5d 08             	mov    0x8(%ebp),%ebx
  Header *bp, *p;

  bp = (Header*)ap - 1;
    3a6c:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3a6f:	a1 00 a4 00 00       	mov    0xa400,%eax
    3a74:	eb 02                	jmp    3a78 <free+0x15>
    3a76:	89 d0                	mov    %edx,%eax
    3a78:	39 c8                	cmp    %ecx,%eax
    3a7a:	73 04                	jae    3a80 <free+0x1d>
    3a7c:	39 08                	cmp    %ecx,(%eax)
    3a7e:	77 12                	ja     3a92 <free+0x2f>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3a80:	8b 10                	mov    (%eax),%edx
    3a82:	39 c2                	cmp    %eax,%edx
    3a84:	77 f0                	ja     3a76 <free+0x13>
    3a86:	39 c8                	cmp    %ecx,%eax
    3a88:	72 08                	jb     3a92 <free+0x2f>
    3a8a:	39 ca                	cmp    %ecx,%edx
    3a8c:	77 04                	ja     3a92 <free+0x2f>
    3a8e:	89 d0                	mov    %edx,%eax
    3a90:	eb e6                	jmp    3a78 <free+0x15>
      break;
  if(bp + bp->s.size == p->s.ptr){
    3a92:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3a95:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3a98:	8b 10                	mov    (%eax),%edx
    3a9a:	39 d7                	cmp    %edx,%edi
    3a9c:	74 19                	je     3ab7 <free+0x54>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    3a9e:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    3aa1:	8b 50 04             	mov    0x4(%eax),%edx
    3aa4:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    3aa7:	39 ce                	cmp    %ecx,%esi
    3aa9:	74 1b                	je     3ac6 <free+0x63>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    3aab:	89 08                	mov    %ecx,(%eax)
  freep = p;
    3aad:	a3 00 a4 00 00       	mov    %eax,0xa400
}
    3ab2:	5b                   	pop    %ebx
    3ab3:	5e                   	pop    %esi
    3ab4:	5f                   	pop    %edi
    ...
    3ab6:	c3                   	ret    
    bp->s.size += p->s.ptr->s.size;
    3ab7:	03 72 04             	add    0x4(%edx),%esi
    3aba:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    3abd:	8b 10                	mov    (%eax),%edx
    3abf:	8b 12                	mov    (%edx),%edx
    3ac1:	89 53 f8             	mov    %edx,-0x8(%ebx)
    3ac4:	eb db                	jmp    3aa1 <free+0x3e>
    p->s.size += bp->s.size;
    3ac6:	03 53 fc             	add    -0x4(%ebx),%edx
    3ac9:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    3acc:	8b 53 f8             	mov    -0x8(%ebx),%edx
    3acf:	89 10                	mov    %edx,(%eax)
    3ad1:	eb da                	jmp    3aad <free+0x4a>
...
morecore(uint nu)
{
    ...
    3ad6:	53                   	push   %ebx
    3ad7:	83 ec 04             	sub    $0x4,%esp
    3ada:	89 c3                	mov    %eax,%ebx
  char *p;
  Header *hp;

  if(nu < 4096)
    3adc:	3d ff 0f 00 00       	cmp    $0xfff,%eax
    3ae1:	77 05                	ja     3ae8 <morecore+0x15>
    nu = 4096;
    3ae3:	bb 00 10 00 00       	mov    $0x1000,%ebx
  p = sbrk(nu * sizeof(Header));
    3ae8:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    3aef:	83 ec 0c             	sub    $0xc,%esp
    3af2:	50                   	push   %eax
    3af3:	e8 a8 fc ff ff       	call   37a0 <sbrk>
  if(p == (char*)-1)
    3af8:	83 c4 10             	add    $0x10,%esp
    3afb:	83 f8 ff             	cmp    $0xffffffff,%eax
    3afe:	74 1c                	je     3b1c <morecore+0x49>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
    3b00:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    3b03:	83 c0 08             	add    $0x8,%eax
    3b06:	83 ec 0c             	sub    $0xc,%esp
    3b09:	50                   	push   %eax
    3b0a:	e8 54 ff ff ff       	call   3a63 <free>
  return freep;
    3b0f:	a1 00 a4 00 00       	mov    0xa400,%eax
    ...
    3b1b:	c3                   	ret    
    return 0;
    3b1c:	b8 00 00 00 00       	mov    $0x0,%eax
    3b21:	eb f4                	jmp    3b17 <morecore+0x44>
...
malloc(uint nbytes)
{
    ...
    3b26:	53                   	push   %ebx
    3b27:	83 ec 04             	sub    $0x4,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    3b2a:	8b 45 08             	mov    0x8(%ebp),%eax
    3b2d:	8d 58 07             	lea    0x7(%eax),%ebx
    3b30:	c1 eb 03             	shr    $0x3,%ebx
    3b33:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
    3b36:	8b 0d 00 a4 00 00    	mov    0xa400,%ecx
    3b3c:	85 c9                	test   %ecx,%ecx
    3b3e:	74 04                	je     3b44 <malloc+0x21>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3b40:	8b 01                	mov    (%ecx),%eax
    3b42:	eb 4a                	jmp    3b8e <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
    3b44:	c7 05 00 a4 00 00 04 	movl   $0xa404,0xa400
    3b4b:	a4 00 00 
    3b4e:	c7 05 04 a4 00 00 04 	movl   $0xa404,0xa404
    3b55:	a4 00 00 
    base.s.size = 0;
    3b58:	c7 05 08 a4 00 00 00 	movl   $0x0,0xa408
    3b5f:	00 00 00 
    base.s.ptr = freep = prevp = &base;
    3b62:	b9 04 a4 00 00       	mov    $0xa404,%ecx
    3b67:	eb d7                	jmp    3b40 <malloc+0x1d>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
    3b69:	74 19                	je     3b84 <malloc+0x61>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
    3b6b:	29 da                	sub    %ebx,%edx
    3b6d:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    3b70:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
    3b73:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
    3b76:	89 0d 00 a4 00 00    	mov    %ecx,0xa400
      return (void*)(p + 1);
    ...
    3b83:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
    3b84:	8b 10                	mov    (%eax),%edx
    3b86:	89 11                	mov    %edx,(%ecx)
    3b88:	eb ec                	jmp    3b76 <malloc+0x53>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3b8a:	89 c1                	mov    %eax,%ecx
    3b8c:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
    3b8e:	8b 50 04             	mov    0x4(%eax),%edx
    3b91:	39 da                	cmp    %ebx,%edx
    3b93:	73 d4                	jae    3b69 <malloc+0x46>
    if(p == freep)
    3b95:	39 05 00 a4 00 00    	cmp    %eax,0xa400
    3b9b:	75 ed                	jne    3b8a <malloc+0x67>
      if((p = morecore(nunits)) == 0)
    3b9d:	89 d8                	mov    %ebx,%eax
    3b9f:	e8 2f ff ff ff       	call   3ad3 <morecore>
    3ba4:	85 c0                	test   %eax,%eax
    3ba6:	75 e2                	jne    3b8a <malloc+0x67>
    3ba8:	eb d5                	jmp    3b7f <malloc+0x5c>
