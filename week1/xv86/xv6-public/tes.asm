...
int main(int argc, char **argv)
{
  ...
  21:	6a 00                	push   $0x0
  23:	e8 2b 03 00 00       	call   353 <signalProcess>

		exit();
  28:	e8 66 02 00 00       	call   293 <exit>
	}
	signalProcess(ret, SIGNAL_KILL);
  2d:	52                   	push   %edx
  2e:	52                   	push   %edx
  2f:	68 be 07 00 00       	push   $0x7be
  34:	50                   	push   %eax
  35:	e8 19 03 00 00       	call   353 <signalProcess>
    // printf(1,"fork no.: %d\n",ret);
    // get_siblings_info();
    ...
    // wait();
    exit();
  3a:	e8 54 02 00 00       	call   293 <exit>
  3f:	90                   	nop
 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 509:	ff 24 85 cc 07 00 00 	jmp    *0x7cc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 617:	90                   	nop
          s = "(null)";
 618:	ba c3 07 00 00       	mov    $0x7c3,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 631:	a1 cc 0a 00 00       	mov    0xacc,%eax
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	89 15 cc 0a 00 00    	mov    %edx,0xacc
}
 678:	5e                   	pop    %esi
 679:	5f                   	pop    %edi
 67a:	5d                   	pop    %ebp
 ...
 6a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ac:	89 15 cc 0a 00 00    	mov    %edx,0xacc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d cc 0a 00 00    	mov    0xacc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 4f                	jae    760 <malloc+0xa0>
    ...
    if(p == freep)
 711:	8b 3d cc 0a 00 00    	mov    0xacc,%edi
 ...
 73a:	e8 f1 fe ff ff       	call   630 <free>
  return freep;
 73f:	8b 15 cc 0a 00 00    	mov    0xacc,%edx
 ...
 76c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 76f:	89 15 cc 0a 00 00    	mov    %edx,0xacc
}
 ...
 77f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 cc 0a 00 00 d0 	movl   $0xad0,0xacc
 787:	0a 00 00 
    base.s.size = 0;
 78a:	bf d0 0a 00 00       	mov    $0xad0,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 d0 0a 00 00 d0 	movl   $0xad0,0xad0
 796:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
