...
0000036b <get_siblings_info>:
SYSCALL(get_siblings_info)
 36b:	b8 19 00 00 00       	mov    $0x19,%eax
 370:	cd 40                	int    $0x40
 372:	c3                   	ret    

00000373 <signalProcess>:
 ...
 4b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f5:	57                   	push   %edi
 4f6:	56                   	push   %esi
 4f7:	e8 d7 fd ff ff       	call   2d3 <write>
 ...
 54e:	e8 80 fd ff ff       	call   2d3 <write>
        putc(fd, c);
 ...
 55f:	57                   	push   %edi
 560:	56                   	push   %esi
 561:	e8 6d fd ff ff       	call   2d3 <write>
        putc(fd, c);
 ...
 60c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 60f:	e8 bf fc ff ff       	call   2d3 <write>
        ap++;
...
free(void *ap)
{
 ...
 651:	a1 0c 0b 00 00       	mov    0xb0c,%eax
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
}
 698:	5e                   	pop    %esi
 699:	5f                   	pop    %edi
 69a:	5d                   	pop    %ebp
 ...
 6c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6cc:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 4f                	jae    780 <malloc+0xa0>
    ...
    if(p == freep)
 731:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
 ...
 743:	e8 f3 fb ff ff       	call   33b <sbrk>
  if(p == (char*)-1)
 ...
 75a:	e8 f1 fe ff ff       	call   650 <free>
  return freep;
 75f:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
 ...
 78c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 78f:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
}
 ...
 79f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 0c 0b 00 00 10 	movl   $0xb10,0xb0c
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf 10 0b 00 00       	mov    $0xb10,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 10 0b 00 00 10 	movl   $0xb10,0xb10
 7b6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
