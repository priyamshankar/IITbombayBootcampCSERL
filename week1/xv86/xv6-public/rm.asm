...
printint(int fd, int xx, int base, int sgn)
{
 ...
 330:	0f b6 92 b8 06 00 00 	movzbl 0x6b8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 3fd:	ff 24 85 60 06 00 00 	jmp    *0x660(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 462:	75 15                	jne    479 <printf+0xfa>
          s = "(null)";
 464:	be 59 06 00 00       	mov    $0x659,%esi
...
free(void *ap)
{
 ...
 4f1:	a1 64 09 00 00       	mov    0x964,%eax
 ...
 52d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 52f:	a3 64 09 00 00       	mov    %eax,0x964
}
 534:	5b                   	pop    %ebx
 535:	5e                   	pop    %esi
 536:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 58c:	e8 54 ff ff ff       	call   4e5 <free>
  return freep;
 591:	a1 64 09 00 00       	mov    0x964,%eax
...
malloc(uint nbytes)
{
 ...
 5b5:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 5b8:	8b 0d 64 09 00 00    	mov    0x964,%ecx
 ...
 5c4:	eb 4a                	jmp    610 <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 5c6:	c7 05 64 09 00 00 68 	movl   $0x968,0x964
 5cd:	09 00 00 
 5d0:	c7 05 68 09 00 00 68 	movl   $0x968,0x968
 5d7:	09 00 00 
    base.s.size = 0;
 5da:	c7 05 6c 09 00 00 00 	movl   $0x0,0x96c
 5e1:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 5e4:	b9 68 09 00 00       	mov    $0x968,%ecx
 ...
 5f5:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 5f8:	89 0d 64 09 00 00    	mov    %ecx,0x964
      return (void*)(p + 1);
 ...
 615:	73 d4                	jae    5eb <malloc+0x46>
    if(p == freep)
 617:	39 05 64 09 00 00    	cmp    %eax,0x964
