...
printint(int fd, int xx, int base, int sgn)
{
 ...
 388:	0f b6 92 10 07 00 00 	movzbl 0x710(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 455:	ff 24 85 b8 06 00 00 	jmp    *0x6b8(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 4ba:	75 15                	jne    4d1 <printf+0xfa>
          s = "(null)";
 4bc:	be b1 06 00 00       	mov    $0x6b1,%esi
...
free(void *ap)
{
 ...
 549:	a1 bc 09 00 00       	mov    0x9bc,%eax
 ...
 585:	89 08                	mov    %ecx,(%eax)
  freep = p;
 587:	a3 bc 09 00 00       	mov    %eax,0x9bc
}
 58c:	5b                   	pop    %ebx
 58d:	5e                   	pop    %esi
 58e:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 5e4:	e8 54 ff ff ff       	call   53d <free>
  return freep;
 5e9:	a1 bc 09 00 00       	mov    0x9bc,%eax
...
malloc(uint nbytes)
{
 ...
 60d:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 610:	8b 0d bc 09 00 00    	mov    0x9bc,%ecx
 ...
 61c:	eb 4a                	jmp    668 <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 61e:	c7 05 bc 09 00 00 c0 	movl   $0x9c0,0x9bc
 625:	09 00 00 
 628:	c7 05 c0 09 00 00 c0 	movl   $0x9c0,0x9c0
 62f:	09 00 00 
    base.s.size = 0;
 632:	c7 05 c4 09 00 00 00 	movl   $0x0,0x9c4
 639:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 63c:	b9 c0 09 00 00       	mov    $0x9c0,%ecx
 ...
 64d:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 650:	89 0d bc 09 00 00    	mov    %ecx,0x9bc
      return (void*)(p + 1);
 ...
 66d:	73 d4                	jae    643 <malloc+0x46>
    if(p == freep)
 66f:	39 05 bc 09 00 00    	cmp    %eax,0x9bc
